...
with pm.Model() as model:
    # we will modelling fact's soft evidence as extra parent node of this fact
    e1_soft_prob = np.array([1, 0])
    # e1 has 2 parents (soft evidence + h1) and 2 values => we have to define 2x2x2 matrix
    e1_prob = np.array([
       [
           [0.999, 0.001],
           [0.001, 0.999],
    ...
    e1_soft = pm.Categorical('e1_soft', p=e1_soft_prob)
    ...
    e1_prob_final = e1_prob_shared[0, h1]  # select the prob array that "happened" thanks to parents
